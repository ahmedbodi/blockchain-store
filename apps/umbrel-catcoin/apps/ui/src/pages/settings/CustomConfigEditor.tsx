...
export default function CustomConfigEditor() {
	...
	return (
		<div className='border border-white/20 rounded-lg p-4 w-full'>
			<label className='text-[14px] font-[400] text-white'>Custom catcoin.conf overrides</label>
			<p className='text-[13px] font-[400] text-white/60'>
				Add custom catcoin.conf options here. Any options here will override settings from the other tabs.
			</p>
			...
			<Button
				...
				onClick={() =>
					save.mutate(text, {
						onSuccess: () => toast.success('Overrides saved; restarting Catcoin Core…'),
