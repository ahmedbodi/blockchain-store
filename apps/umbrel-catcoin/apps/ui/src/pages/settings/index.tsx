...
export default function SettingsCard() {
	...
	const onUpdateSettings = (data: SettingsSchema) => {
		...
		updateTimer.current = setTimeout(() => {
			updateToastId.current = toast.loading('Hang tight, Catcoin Core is restarting...', {duration: Infinity})
		}, 1000)
	...
	const onRestoreDefaults = () => {
		...
		restoreTimer.current = setTimeout(() => {
			restoreToastId.current = toast.loading('Hang tight, Catcoin Core is restarting...', {duration: Infinity})
		}, 1000)
